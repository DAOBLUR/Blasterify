<%@ Page Title="Create Subscription" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreateSubscription.aspx.cs" Inherits="BlasterifyAdmin.CreateSubscription" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Button ID="CreateBtn" runat="server" Text="Create" CssClass="btn btn-sm btn-success me-5" 
        OnClick="CreateBtn_Click" Font-Size="15" />
